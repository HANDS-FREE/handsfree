...
private:
    ...
    inline void writeBufferUpdate()
    {
        ...
        if (with_arm_)
        {
            ...
            hf_hw_.getRobotAbstract()->expect_arm_state.servo5 = arm_cmd_[4];
            hf_hw_.getRobotAbstract()->expect_arm_state.servo6 = arm_cmd_[5];
        }
        // the servo num is different
        hf_hw_.getRobotAbstract()->expect_head_state.pitch  = head_servo1_cmd_;
        hf_hw_.getRobotAbstract()->expect_head_state.yaw  = head_servo2_cmd_;
    }
    ...
    inline void readBufferUpdate()
    {
        ...
        if (with_arm_)
        {
            ...
            arm_pos_[4] = hf_hw_.getRobotAbstract()->measure_arm_state.servo5;
            arm_pos_[5] = hf_hw_.getRobotAbstract()->measure_arm_state.servo6;
        }
        ...
        head_servo1_pos_ = hf_hw_.getRobotAbstract()->measure_head_state.pitch ;
        head_servo1_vel_ = 0 ;
        head_servo1_eff_ = 0 ;

        head_servo2_pos_ = hf_hw_.getRobotAbstract()->measure_head_state.yaw ;
        head_servo2_vel_ = 0 ;
        head_servo2_eff_ = 0 ;
