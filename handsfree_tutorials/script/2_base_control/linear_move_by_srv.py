...
def callback_linear_move(req):
    move_dis.move_to_target(dis_to_move=req.target_distance_move)
    return handsfree_srv.SpecialMoveResponse(True)
...
if __name__ == '__main__':
    ...
    rospy.loginfo("********************************************************")
    rospy.loginfo("*           linear move start successfully !           *")
    rospy.loginfo("********************************************************")
    rospy.spin()
